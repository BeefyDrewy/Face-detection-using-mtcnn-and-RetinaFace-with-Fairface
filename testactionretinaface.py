...
def test_analyze_crowded_photo():
    img_path = r"C:\Users\USER\retinaface\tests\dataset\img3.jpg"
...
def test_alignment_for_inverse_clock_way():
    ...
    img_path = r"C:\Users\USER\retinaface\tests\dataset\img11.jpg"
    img = cv2.imread(img_path)
...
def test_resize():
    faces = RetinaFace.extract_faces(img_path=r"C:\Users\USER\retinaface\tests\dataset\img11.jpg", target_size=(224, 224))
    for face in faces:
